...
from kuzu_memory.mcp.protocol import JSONRPCMessage, JSONRPCError, JSONRPCErrorCode
...
def test_message_formatting():
    ...
    response = JSONRPCMessage.create_response(
        request_id=1,
        result={'tools': ['enhance', 'learn', 'recall']}
    )
    ...
    full_response = JSONRPCMessage.create_response(
        request_id=3,
