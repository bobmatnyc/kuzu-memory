...
def test_functionality():
    ...
    dev_tests = [
        ("./kuzu-memory.sh remember 'I am testing the development setup' --user-id test-dev", "Store memory (dev)"),
        ("./kuzu-memory.sh recall 'What am I testing?' --user-id test-dev", "Recall memory (dev)"),
    ...
    prod_tests = [
        ("kuzu-memory remember 'I am testing the production setup' --user-id test-prod", "Store memory (prod)"),
        ("kuzu-memory recall 'What am I testing?' --user-id test-prod", "Recall memory (prod)"),
...
def main():
    ...
    if passed_tests == total_tests:
        ...
        print(f"\n🚀 Setup Summary:")
        print(f"  • Development: ./kuzu-memory.sh [command]")
        print(f"  • Production:  kuzu-memory [command]")
        print(f"  • Help:        kuzu-memory --help")
        print(f"  • Demo:        kuzu-memory demo")
