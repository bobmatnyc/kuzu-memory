...
class TestDeduplicationEngine:
    ...
    def strict_dedup_engine(self):
        ...
        return DeduplicationEngine(
            near_threshold=0.98, semantic_threshold=0.95, min_length_for_similarity=20
        )
    ...
    def lenient_dedup_engine(self):
        ...
        return DeduplicationEngine(
            near_threshold=0.80, semantic_threshold=0.70, enable_update_detection=False
        )
    ...
    def test_deduplication_action_store_new(self, dedup_engine, sample_memories):
        ...
        assert (
            "No duplicates found" in action["reason"]
            or "sufficiently different" in action["reason"]
        )
    ...
    def test_threshold_boundary_values(self):
        ...
        engine = DeduplicationEngine(
            near_threshold=1.0, semantic_threshold=0.0, min_length_for_similarity=1
        )
