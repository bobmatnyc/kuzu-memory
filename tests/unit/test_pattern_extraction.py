...
class TestPatternExtractor:
    ...
    def test_custom_patterns_integration(self, custom_pattern_extractor):
        ...
        custom_memories = [m for m in memories if m.pattern_used in ["test_pattern", "custom_identity"]]
    ...
    def test_preference_pattern_extraction(self, pattern_extractor):
        ...
        test_cases = [
            ("I prefer Python for backend development.", "Python for backend development"),
    ...
    def test_decision_pattern_extraction(self, pattern_extractor):
        ...
        test_cases = [
            ("We decided to use PostgreSQL for the database.", "use PostgreSQL for the database"),
    ...
    def test_correction_pattern_extraction(self, pattern_extractor):
        ...
        for text, expected_content in test_cases:
            ...
            assert len(high_confidence_memories) > 0, f"No high-confidence memory for correction: {text}"
