...
from kuzu_memory.extraction.entities import EntityExtractor, Entity
...
class TestEntityExtractor:
    ...
    def test_programming_language_extraction(self, entity_extractor):
        ...
        test_cases = [
            ...
            ("JavaScript and TypeScript are great for frontend.", ["JavaScript", "TypeScript"]),
        ...
        for text, expected_languages in test_cases:
            ...
            for expected_lang in expected_languages:
                assert expected_lang in found_languages, f"Expected language '{expected_lang}' not found"
    ...
    def test_technology_framework_extraction(self, entity_extractor):
        ...
        test_cases = [
            ...
            ("Our backend uses Django, Flask, and FastAPI.", ["Django", "Flask", "FastAPI"]),
            ("Spring Boot and Express.js are our main frameworks.", ["Spring Boot", "Express.js"]),
        ...
        for text, expected_techs in test_cases:
            ...
            for expected_tech in expected_techs:
                ...
                found_match = any(expected_tech.lower() in found_tech.lower() 
    ...
    def test_person_name_extraction(self, entity_extractor):
        ...
        test_cases = [
            ...
            ("Bob Smith and Carol Davis are working together.", ["Bob Smith", "Carol Davis"]),
        ...
        for text, expected_names in test_cases:
            ...
            if expected_names:  # Only assert if we expect to find names
                ...
                for expected_name in expected_names:
                    found_match = any(expected_name.lower() in found_name.lower() 
        ...
        for text, expected_orgs in test_cases:
            ...
            if expected_orgs:
                ...
                for expected_org in expected_orgs:
                    found_match = any(expected_org.lower() in found_org.lower() 
    ...
    def test_file_extraction(self, entity_extractor):
        ...
        test_cases = [
            ...
            ("Check package.json and requirements.txt.", ["package.json", "requirements.txt"]),
            ("The config.yaml file contains settings.", ["config.yaml"]),
            ("Run the test_models.py script.", ["test_models.py"]),
            ("Update the Dockerfile and docker-compose.yml.", ["Dockerfile", "docker-compose.yml"]),
        ]
        ...
        for text, expected_versions in test_cases:
            ...
            if expected_versions:
                ...
                for expected_version in expected_versions:
                    assert expected_version in found_versions, f"Expected version '{expected_version}' not found"
