    ...
    def recall(
        ...
        try:
            ...
            if (self.config.performance.enable_performance_monitoring and 
                execution_time > self.config.performance.max_recall_time_ms):
...
class KeywordRecallStrategy(RecallStrategy):
    ...
    def __init__(self, db_adapter: KuzuAdapter, config: KuzuMemoryConfig):
        ...
        self.stop_words = {
            ...
            'when', 'where', 'who', 'why', 'do', 'does', 'did', 'we', 'our', 
            'my', 'your', 'i', 'you', 'he', 'she', 'it', 'they', 'them',
            'this', 'that', 'these', 'those', 'and', 'or', 'but', 'so',
            'if', 'then', 'can', 'will', 'would', 'could', 'should'
        }
