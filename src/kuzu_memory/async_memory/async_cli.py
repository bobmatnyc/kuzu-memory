...
from .background_learner import get_background_learner, learn_async, store_async
from .status_reporter import get_status_reporter, ReportLevel
from .queue_manager import get_queue_manager, TaskStatus
...
class AsyncMemoryCLI:
    ...
    def learn_async(
        ...
        """
        Asynchronous learning (non-blocking).
...
_async_cli: Optional[AsyncMemoryCLI] = None


def get_async_cli(db_path: Optional[Path] = None) -> AsyncMemoryCLI:
