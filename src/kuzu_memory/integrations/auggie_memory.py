...
class ResponseLearner:
    ...
    def _extract_patterns(self, prompt: str, response: str,
    ...
    def _assess_response_quality(self, prompt: str, response: str,
        ...
        try:
            ...
            coherence_indicators = [
                "however", "therefore", "because", "additionally", "furthermore",
                "in conclusion", "for example", "specifically", "moreover"
            ]
            ...
            if context_memories:
                ...
                assessment["context_usage_score"] = min(1.0, keyword_overlap / max(len(context_keywords), 1))
    ...
    def _process_feedback(self, feedback: Dict[str, Any], learning_results: Dict[str, Any]):
    ...
    def _identify_domain(self, prompt: str) -> Optional[str]:
        """Identify the domain/topic of the prompt."""
        domain_keywords = {
            "programming": ["code", "function", "variable", "programming", "software", "development"],
    ...
    def get_learning_statistics(self) -> Dict[str, Any]:
        ...
        if self.response_quality_cache:
            avg_quality = sum(assessment["overall_score"] for assessment in self.response_quality_cache)
    ...
    def get_recommendations(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            effective_contexts = {
                context_type: data for context_type, data in self.context_patterns.items()
