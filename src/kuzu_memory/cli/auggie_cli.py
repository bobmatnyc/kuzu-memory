...
from ..integrations.auggie import AuggieIntegration, AuggieRule, RuleType, RulePriority
...
def main():
    ...
    create_parser.add_argument("rule_type", choices=["context_enhancement", "prompt_modification", "response_filtering", "learning_trigger", "memory_prioritization"])
