        ...
        with KuzuMemory(db_path=db_path) as memory:
            ...
            if not memories:
                if output_format == 'json':
                    ...
                    rich_print(f"ℹ️  No relevant memories found for: '{prompt}'", style="blue")
            ...
            if output_format == 'json':
                ...
                rich_panel(f"Found {len(memories)} relevant memories:", title="📚 Context", style="green")
                rich_print(f"\n{context}\n")
                rich_panel(memory_context.enhanced_prompt or prompt, title="🔍 Enhanced Prompt", style="blue")
    ...
    try:
        ...
        if use_sync:
            ...
            try:
                ...
                if not quiet:
                    rich_print(f"⚠️  Async learning not available ({e}), falling back to sync", style="yellow")
