...
class MemoryCache:
    ...
    def _generate_query_key(self, query: str, parameters: Optional[Dict[str, Any]] = None) -> str:
    ...
    def get_query_result(self, query: str, parameters: Optional[Dict[str, Any]] = None) -> Optional[List[Dict[str, Any]]]:
        """Get cached query result."""
        key = self._generate_query_key(query, parameters)
        return self._query_cache.get(key)
    
    def put_query_result(self, query: str, parameters: Optional[Dict[str, Any]], result: List[Dict[str, Any]]) -> None:
        """Cache query result."""
        key = self._generate_query_key(query, parameters)
        self._query_cache.put(key, result)
    
    def get_recall_result(self, prompt: str, strategy: str, max_memories: int) -> Optional[MemoryContext]:
